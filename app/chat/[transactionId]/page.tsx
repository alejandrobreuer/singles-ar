...
export default async function ChatPage({
  ...
  // ── Fetch current user's existing review, if any (for completed transactions) ─
  // Full row (not just existence) so ReviewForm can pre-fill an edit — e.g. a
  // review auto-generated by the 72h auto-close cron that the buyer wants to
  // correct.
  let existingReview: { id: string; rating: number; comment: string | null; auto_generated: boolean } | null = null;
